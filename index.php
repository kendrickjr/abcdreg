...
<body>
 <?php
    if( $_POST) {
      if( $savestring ) 
        echo "<script type='text/javascript'>alert('Thank you $name!, your details was submitted successfully!, please visit the Library with your passport photo if you have Question please call us on +255 784 610 605 or via Mail on info@dlts.mzumbe.ac.tz')</script>";
      else
...
<table width="769" border="0" align="center">
  <tr>
    <td width="826" height="108"><img src="images/banner.png" width="826" height="108" alt="Register at Mzumbe university Library" longdesc="http://www.main.mzumbe.ac.tz" /></td>
  </tr>
  <tr>
    <td>
...
<option value="Undegraduate">Undergarduate</option>
...
<option value="VLIR/OUS">VLIR/OUS</option>
...
<option value="Others">Others</option>
     ...
     <tr>
      <td width="33%">Adress</td>
      <td width="67%"><label>
        <input type="text" name="adress" required="required" placeholder="P.o.Box 12" formnovalidate="formnovalidate" />
      </label></td>
    </tr>
    <tr>
...
<option value="Zimbabwe">Zimbabwe</option>
    ...
    <tr>
      ...
      <td width="67%"><label>
        <input type="number" name="phone" required placeholder="e.g 255784610605"/>
      </label></td>
    </tr>
    <tr>
      <td>Email</td>
